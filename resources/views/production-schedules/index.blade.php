                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="production_line" id="production_line" class="form-select">
                                    ...
                                    <option value="Line A" {{ request('production_line') == 'LineA' ? 'selected' : '' }}>Line A</option>
                                    <option value="Line B" {{ request('production_line') == 'LineB' ? 'selected' : '' }}>Line B</option>
                                    <option value="Line C" {{ request('production_line') == 'LineC' ? 'selected' : '' }}>Line C</option>
                                    <option value="Line D" {{ request('production_line') == 'LineD' ? 'selected' : '' }}>Line D</option>
                                </select>
                            </div>
                            <div class="col-md-4">
